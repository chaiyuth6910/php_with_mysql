...
<head>
    ...
    <meta charset="utf-8">
    <meta name="description" content="PHP with MySQL">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Home | PHP with MySQL</title>
    </head>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Basic PHP MySQL</a>
            </div>
    ...
    <!-- jQuery -->
    <script src="library/jquery/jquery-2.2.3.min.js"></script>
